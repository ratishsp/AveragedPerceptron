 ...
 *
 */
public class PerceptronBigramIJC {
...
//	private static final String TRAINING_FILE = "/home/arya/Downloads/IJCNLP-NER/training-hindi/combined.bio.fourtags.features";
	private static final String TRAINING_FILE = "/home/arya/Project/ililmt/ner/pos/HindiPOSTagged.Cleaned.tagged.train.hi";
//	private static final String GENE_MODEL_GEN = "/home/ratish/project/study/nlp/h4-assignment/tag.modelgen"; 
	private static final String MODEL_GEN_FILE ="/home/arya/Project/ililmt/ner/pos/model/modelfile.wordvec.w1.perceptron";
	
	private static final String TAB = "\t";
	private static final String DEV_OUT_FILE = "/home/arya/Project/ililmt/ner/pos/model/test-data-hindi.out.wordvec.w1.perceptron";
...
//	private static final String DEV_FILE = "/home/arya/Downloads/IJCNLP-NER/test-data-hindi.fourtags.bio";
	private static final String DEV_FILE = "/home/arya/Project/ililmt/ner/pos/HindiPOSTagged.Cleaned.tagged.test.hi";
...
//	private static final String MODEL_GEN_AVG_OPTIM = "/home/arya/Project/ililmt/ner/IJC/model/modelfileoptim.wordvec.10iter.w1.perceptron";
	private static final String MODEL_GEN_AVG_OPTIM = "/home/arya/Project/ililmt/ner/pos/model/modelfileoptim.wordvec.w1.perceptron";
	private Map<String, String> wordClusters;
	private List<String> outputTags;
	public static void main(String[] args) {
		PerceptronBigramIJC perceptron = new PerceptronBigramIJC();
...
//		}
	...
	private List<String> loadTags(){
		...
		try {
			BufferedReader br = new BufferedReader(new FileReader("/home/arya/Project/ililmt/ner/pos/uniqposttags"));
...
//				posTags.add(args[11]);
					...
					tags = viterbiImplementation(input,vMap, posTags);
					writeDevTags(bw1, input,goldStandardTags, tags);
					input = new ArrayList<String>();
					posTags = new ArrayList<String>();
					goldStandardTags = new ArrayList<String>();
				}
	...
	private void writeDevTags(BufferedWriter bw1, List<String> input,
			 List<String> goldStandardTags, List<String> tags) throws IOException {
		for(int i = 0; i< input.size(); i++){
			bw1.write(input.get(i)+TAB+ goldStandardTags.get(i)+TAB+tags.get(i));
			bw1.newLine();
		}
		bw1.newLine();
	}
...
//						System.out.println("inter piValue "+piValue+" piKMinus1 "+piKMinus1+" "+ bigramFeature + " trigram value "+ bigram +" "+ tagFeature+" "+tag+ " ");//+suffixFeature1 + " "+suffix1 +" "+suffixFeature2 + " "+ suffix2 +" "+suffixFeature3 + " "+ suffix3);
//						System.out.println("");
					}
					pi.put(kuv, maxValue);
					bp.put(kuv, maxKuv);
